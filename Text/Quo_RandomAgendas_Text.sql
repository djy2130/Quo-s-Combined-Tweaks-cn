...
INSERT OR REPLACE INTO LocalizedText
	(Language, Text, Tag)
SELECT "en_US", OriginalDesc || '[NEWLINE][NEWLINE][ICON_CAPITAL]This leader shares rewards with comrades.[NEWLINE][ICON_BOLT]To exploit this agenda: Befriend them while while at peace with their neighbors.[NEWLINE][ICON_BOLT]Reward: ' 
...
INSERT OR REPLACE INTO LocalizedText
	(Language, Text, Tag)
SELECT "en_US", OriginalDesc || '[NEWLINE][NEWLINE][ICON_CAPITAL]This leader achieves goals by stirring drama and controversy.[NEWLINE][ICON_BOLT]To exploit this agenda: Befriend them while at war with their neighbors.[NEWLINE][ICON_BOLT]Reward: ' 
