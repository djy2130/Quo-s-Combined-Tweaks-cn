...
-- SURVEY
UPDATE LocalizedText SET Text='侦察单位2倍经验. 侦察单位和移民无视河流和控制区.' WHERE Tag='LOC_POLICY_SURVEY_DESCRIPTION' ;
...
UPDATE LocalizedText SET Text=' +1 [ICON_HOUSING] 在所有城市.' WHERE Tag='LOC_POLICY_INSULAE_DESCRIPTION' ;
...
-- NEW DEAL
UPDATE LocalizedText SET Text='+4 [ICON_Housing] 住房, +2 [ICON_Amenities] 舒适, -8 [ICON_Gold] 金钱在所有城市.' WHERE Tag='LOC_POLICY_NEW_DEAL_DESCRIPTION' ;


-- CORVEE, GOTHIC ARCHITECTURE, SKYSCRAPERS
UPDATE LocalizedText SET Text='+30% [ICON_Production] 生产力对古典时代的奇迹.' WHERE Tag='LOC_POLICY_CORVEE_DESCRIPTION' ;
UPDATE LocalizedText SET Text='+30% [ICON_Production] 生产力对中世纪时代的奇迹.' WHERE Tag='LOC_POLICY_GOTHIC_ARCHITECTURE_DESCRIPTION' ;
...
-- VETERANCY
UPDATE LocalizedText SET Text='+100% [ICON_PRODUCTION] 生产力对军营区和里面的建筑.' WHERE Tag='LOC_POLICY_VETERANCY_DESCRIPTION' ;
...
UPDATE LocalizedText SET Text='+30% 城市增长速度对不在你首都 [ICON_Capital] 大陆的城市.' WHERE Tag='LOC_POLICY_COLONIAL_OFFICES_DESCRIPTION' ;
...
UPDATE LocalizedText SET Text='+30% [ICON_PRODUCTION] 对古典时代的近战和远程单位' WHERE Tag='LOC_POLICY_AGOGE_DESCRIPTION' ;
UPDATE LocalizedText SET Text='+40% [ICON_PRODUCTION] 对文艺复兴时期的近战和远程单位' WHERE Tag='LOC_POLICY_FEUDAL_CONTRACT_DESCRIPTION' ;
UPDATE LocalizedText SET Text='+50% [ICON_PRODUCTION] 对现代的近战和远程单位' WHERE Tag='LOC_POLICY_GRANDE_ARMEE_DESCRIPTION' ;
UPDATE LocalizedText SET Text='+50% [ICON_PRODUCTION] 对任何时代的近战和远程单位' WHERE Tag='LOC_POLICY_MILITARY_FIRST_DESCRIPTION' ;

UPDATE LocalizedText SET Text='+30% [ICON_PRODUCTION] 对古典时代的骑手单位' WHERE Tag='LOC_POLICY_MANEUVER_DESCRIPTION' ;
UPDATE LocalizedText SET Text='+40% [ICON_PRODUCTION] 对工业时代的骑手单位' WHERE Tag='LOC_POLICY_CHIVALRY_DESCRIPTION' ;
UPDATE LocalizedText SET Text='+50% [ICON_PRODUCTION] 对所有的骑手单位' WHERE Tag='LOC_POLICY_LIGHTNING_WARFARE_DESCRIPTION' ;


UPDATE LocalizedText SET Text='+100% [ICON_PRODUCTION] 对古典时代的海军单位' WHERE Tag='LOC_POLICY_MARITIME_INDUSTRIES_DESCRIPTION' ;
UPDATE LocalizedText SET Text='+100% [ICON_PRODUCTION] 对工业时代的海军单位' WHERE Tag='LOC_POLICY_PRESS_GANGS_DESCRIPTION' ;
UPDATE LocalizedText SET Text='+100% [ICON_PRODUCTION] 除了航母以外的所有海军单位' WHERE Tag='LOC_POLICY_INTERNATIONAL_WATERS_DESCRIPTION' ;
...
-- support
UPDATE LocalizedText SET Text='[ICON_Production][ICON_RESOURCE_MERCURY]卫国战争' WHERE Tag='LOC_POLICY_PATRIOTIC_WAR_NAME' ;
...
UPDATE LocalizedText SET Text='[ICON_BOLT][ICON_SCIENCE] 理性主义' WHERE Tag='LOC_POLICY_RATIONALISM_NAME' ;
UPDATE LocalizedText SET Text='[ICON_BOLT][ICON_FAITH] 殖民地税收' WHERE Tag='LOC_POLICY_SIMULTANEUM_NAME' ;
...
UPDATE LocalizedText SET Text='+1 [ICON_Gold] 金在每个改良的奢侈品和战略资源对国际商路 [ICON_TRADEroute].+2 [ICON_Culture]文化和+2[ICON_Science] 科学. ' WHERE Tag='LOC_POLICY_MARKET_ECONOMY_DESCRIPTION' ;
